...
export default function DemoReactivationPage() {
  return <div className="min-h-screen bg-[#ece4d8] text-[#302d28] lg:flex"><DemoSidebar/><main className="min-w-0 flex-1 p-6 md:p-8 lg:p-10"><div className="mx-auto max-w-7xl">
