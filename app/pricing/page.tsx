    ...
    <main className="min-h-screen bg-[#efe6d8] px-6 py-8 text-[#292722] md:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mx-auto mt-16 max-w-3xl text-center">
          ...
          <p className="mt-2 text-sm font-medium text-[#7a674d]">La web inmobiliaria propia, matching, distribución, documentos, automatizaciones, comisiones y WhatsApp IA están disponibles desde Professional. Enterprise suma firma avanzada integrada, dominio propio, white-label y proyectos en pozo.</p>
