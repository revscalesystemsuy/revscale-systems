    ...
    <main className="min-h-screen bg-[#efe6d8] px-6 py-8 text-[#292722] md:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mx-auto mt-16 max-w-3xl text-center">
          ...
          <p className="mt-2 text-sm font-medium text-[#7a674d]">WhatsApp IA está disponible desde Professional. Proyectos en pozo está incluido en Enterprise.</p>
