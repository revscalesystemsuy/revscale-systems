...
export default async function PricingPage({ searchParams }: { searchParams: Promise<{ email?: string; new?: string; cycle?: string }> }) {
  ...
  const plans = [
    { name: "STARTER", title: "Starter", monthly: 99, annual: 990, description: "Para inmobiliarias pequeñas que quieren ordenar su operación comercial.", features: ["3 agentes", "500 leads", "100 propiedades", "Gestión comercial de leads", "Seguimientos y tareas"], lockedFeatures: ["WhatsApp IA"] },
    ...
    { name: "ENTERPRISE", title: "Enterprise", monthly: 499, annual: 4990, description: "Para inmobiliarias con equipos grandes, automatizaciones y procesos más complejos.", features: ["Hasta 30 agentes", "Multi equipo", "Roles y asignación automática", "Integraciones", "WhatsApp IA con mayor escala y operación por equipos", "Soporte prioritario"] },
  ]
    ...
    <main className="min-h-screen bg-[#efe6d8] px-6 py-8 text-[#292722] md:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mx-auto mt-16 max-w-3xl text-center">
          ...
          <p className="mt-2 text-sm font-medium text-[#7a674d]">WhatsApp IA está disponible desde Professional.</p>
