...
import { ArrowLeft, CheckCircle2, CircleDashed, ExternalLink, Mail, MessageCircle, Phone } from "lucide-react";
  ...
  return (
    <main className="min-h-screen bg-[#f3ecdf] p-6 text-[#302d28] md:p-8 lg:p-10">
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-wrap items-center justify-between gap-3"><Link href="/protected/admin/sales/prospects/decision-makers" className="inline-flex items-center gap-2 text-sm text-[#7a6e5c]"><ArrowLeft size={15}/> Volver a Owner / Manager</Link><div className="flex flex-wrap gap-2"><Link href="/protected/admin/sales/prospects/email" className="inline-flex items-center gap-2 rounded-lg bg-[#302d28] px-4 py-2.5 text-sm font-semibold text-[#fffaf2]"><Mail size={15}/> Email</Link><Link href="/protected/admin/sales/prospects" className="rounded-lg border border-[#b9aa94] bg-[#fffaf2] px-4 py-2.5 text-sm font-semibold text-[#574936]">Base de prospectos</Link></div></div>
