    ...
    <main className="min-h-screen p-6 md:p-8 lg:p-10">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-6">
          ...
          <p className="mt-3 text-sm leading-6 text-[#625d55]">Actualizá cualquier dato y guardá los cambios. El inventario y el matching usarán la información nueva.</p>
        </div>
        ...
        <form action={updateProperty} className="mt-8 rounded-xl border border-[#d2c5b3] bg-[#f7f0e6] p-6 shadow-[0_18px_45px_rgba(72,58,40,0.04)]">
          ...
          <div className="mt-5 grid gap-5 md:grid-cols-3">
            ...
            <label className={labelClass}>Estado
              <select name="status" defaultValue={property.status || "AVAILABLE"} className={inputClass}>
          ...
          <label className={`mt-5 block ${labelClass}`}>Descripción
            <textarea name="description" rows={6} defaultValue={property.description || ""} className={inputClass} />
          </label>

          <div className="mt-6 flex flex-wrap gap-3">
            <button type="submit" className="inline-flex items-center gap-2 rounded-lg bg-[#302d28] px-5 py-3 text-sm font-semibold !text-[#fffaf2] transition hover:bg-[#3b3731]">
