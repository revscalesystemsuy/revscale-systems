...
export const PLAN_CATALOG: Record<PaidPlanName, PaidPlanCatalogItem> = {
  STARTER: {
    ...
    description: "La operación comercial esencial para dejar de perder leads, tareas y oportunidades.",
    monthly: 99,
    annual: 990,
    popular: false,
    ...
    demo: {
      ...
      description: "Recorré una inmobiliaria chica con leads, pipelines de venta y alquiler, propiedades, interacciones, agenda y seguimientos sin módulos avanzados habilitados.",
      experiences: [
  ...
  PROFESSIONAL: {
    ...
    description: "Convierte RevScale en el sistema operativo comercial completo de la inmobiliaria: IA, automatización, web, documentos y control de performance.",
    monthly: 249,
    annual: 2490,
    popular: true,
    ...
    demo: {
      title: "Automatizá la conversión y trabajá con más criterio.",
      description: "Professional suma la capa de crecimiento: Matching, WhatsApp IA, automatizaciones, comisiones, web inmobiliaria, distribución, documentos, reportes y analítica avanzada.",
      experiences: [
        "Trabajar con hasta 15 agentes y volumen ilimitado de leads y propiedades.",
        "Usar Matching y WhatsApp IA para priorizar, responder y derivar oportunidades.",
        "Explorar automatizaciones, comisiones, documentos y el sitio inmobiliario público.",
        "Medir rendimiento con Reportes y Analítica avanzada.",
      ],
      footer: "Es el plan recomendado para inmobiliarias que ya tienen flujo de leads y quieren convertir más sin sumar trabajo manual.",
    },
  },
  ENTERPRISE: {
    name: "ENTERPRISE",
    ...
    description: "Agrega gobierno operativo, captación, desarrollos y controles avanzados para organizaciones inmobiliarias más complejas.",
    monthly: 499,
    annual: 4990,
    popular: false,
    ...
    lockedFeatures: [],
    demo: {
      title: "Escalá equipos, captación y operaciones complejas.",
      description: "Enterprise incluye todo Professional y agrega multi-equipo, asignación automática, territorios de captación, proyectos en pozo, firma avanzada, control legal, dominio propio e integraciones.",
      experiences: [
